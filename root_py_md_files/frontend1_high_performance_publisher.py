...
class HighPerformancePublisher:
    def __init__(self):
        self.client = mqtt.Client(client_id="frontend1_high_perf_publisher", protocol=mqtt.MQTTv311, clean_session=True)
    ...
    def on_connect(self, client, userdata, flags, rc):
        if rc == 0:
            print(f"✅ Frontend-1 High Performance Publisher connected to MQTT broker")
    ...
    def on_disconnect(self, client, userdata, rc):
        print(f"🔌 Frontend-1 High Performance Publisher disconnected (rc={rc})")
        self.connection_established = False
    ...
    def generate_data_point(self, message_id):
        ...
        base_displacement = 10.0 + (message_id * 0.001)  # Gradual increase, different from frontend-2
        noise_displacement = random.uniform(-1.5, 1.5)  # High-frequency noise
        displacement = base_displacement + noise_displacement
        
        # Force correlates with displacement but with some variation
        base_force = displacement * 2.5 + random.uniform(-1.5, 1.5)  # Different scaling from frontend-2
        ...
        return {
            ...
            "publisher": "frontend1_high_perf_publisher",
    ...
    def publish_data(self):
        ...
        print(f"\n📊 Frontend-1 High Performance Publisher Statistics:")
    ...
    def start(self):
        ...
        try:
            ...
            print(f"\n⏹️  Stopping Frontend-1 High Performance Publisher...")
            self.is_running = False
        except Exception as e:
            print(f"❌ Error: {e}")
        finally:
            ...
            print("🔌 Frontend-1 Publisher stopped")

def main():
    """Main function to run the High Performance Publisher"""
    print("=" * 80)
    print("🚀 Frontend-1 High Performance Publisher")
    print("=" * 80)
    ...
    print("3. frontend-1 React app is running on port 3001")
