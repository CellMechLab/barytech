  ...
  const handleButtonClick = () => {
    if (type === "connection") {
      ...
      if (socket && socket.readyState === WebSocket.OPEN) {
        ...
        // Data to send over WebSocket with device_id for per-device save
        const data = { 
          type: "save", 
          save: newSaveState,
          device_id: "frontend1_ultra_high_perf_device"  // Target specific device
        };
        ...
        toast(
          newSaveState
            ? "Per-device save enabled! Data will now be saved for this device."
            : "Per-device save disabled! Data saving stopped for this device.",
          {
            style: {
