...
const Dashboard = () => {
  ...
  const { dataBuffer, framesReceived, pointsReceived } = useContext(WebSocketContext);
    ...
    setBoxes((prevBoxes) =>
      prevBoxes.map((box) => {
        if (box.id === 3) {
          ...
          return { ...box, data: framesReceived || 0 };
        } else if (box.id === 6) {
          return { ...box, data: pointsReceived || 0 };
        }
        return box;
      })
    );
  }, [transformedData, framesReceived, pointsReceived]);
    ...
    },
    {
      ...
      content: (
        <StatBox
          ...
          subtitle={`${transformedData.series1?.[0]?.value ? transformedData.series1[0].value.toFixed(2) : "-"} 
      mm`}
        />
      ),
      gridColumn: "span 2",
    ...
    },
    {
      ...
      data: transformedData.series1 || [],
       ...
       content: (
         <StatBox 
           title="Total Frames" 
           subtitle={framesReceived || 0}
           measurementColor="#4CAF50"
         />
       ),
       gridColumn: "span 2",
       gridRow: "span 1",
       ...
       content: (
         <StatBox 
           title="Total Points" 
           subtitle={pointsReceived || 0}
           measurementColor="#B78FEA"
         />
       ),
       gridColumn: "span 2",
       gridRow: "span 1",
       lineColor: "#B78FEA",
       areaColor: "rgba(183, 143, 234, 0.2)",
       data: pointsReceived || 0,
     },
    {
      id: 7,
      gridColumn: "span 12",
